...
export const MESSAGES: Record<string, string> = {
  HOME_PAGE: `
<b>👋 Добро пожаловать в PlanetVPN!</b>
...
• Работает на: <b>iOS, Android, Windows, macOS</b>
...
📌 <i>Автопродление отключено по умолчанию — вы сами решаете, продлевать ли подписку</i>
  ...
  ABOUT_SERVICE_PAGE: `
<b>🛡️ PlanetVPN — надёжный помощник в цифровом мире</b>

<b>📄 Описание</b>

PlanetVPN — это платный доступ к быстрому VPN-серверу в Нидерландах (Амстердам), который позволяет вам обходить блокировки, сохранять анонимность и чувствовать себя уверенно в интернете.
...
• Почта: planetvpn.official@gmail.com 
  ...
  SUBSCRIBING_PAGE: `
<b>🚀 Интернет без границ рядом — подключи PlanetVPN за пару шагов</b>
...
2. Скопируйте свой ключ (выдан в Telegram-боте).
3. В приложении нажмите <b>«Новый профиль»</b> → <b>«Добавить из буфера обмена»</b>.
4. Нажмите кнопку <b>«Нажмите для подключения»</b>.
5. ✅ Готово — вы подключены.
  `,
...
Нажмите кнопку ниже, чтобы продлить доступ и продолжить пользоваться PlanetVPN.
...
Чтобы начать пользоваться PlanetVPN, выберите подходящий тариф и получите полный доступ к интернету без ограничений.
